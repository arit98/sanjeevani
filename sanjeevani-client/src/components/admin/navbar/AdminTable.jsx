...
const AdminTable = () => {
  ...
  return (
    <div className="py-10 -mr-16 overflow-x-auto">
          ...
          <div className="flex flex-col lg:flex-row p-4 lg:p-8 justify-between items-start lg:items-stretch w-full">
            ...
            <div className="w-full lg:w-2/3 flex lg:flex-row items-start lg:items-center justify-end">
              <div className="flex items-center lg:border-l lg:border-r border-gray-300 dark:border-gray-200 py-3 lg:py-0 lg:px-6">
                <p
                  className="md:visible lg:visible invisible text-base text-gray-600 dark:text-gray-400"
                  id="page-view"
                >
                  Viewing 1 - 20 of 60
                </p>
              ...
              <div className="-mt-8 lg:mt-0 md:mt-0 flex items-center lg:border-r border-gray-300 dark:border-gray-200 pb-3 lg:pb-0 lg:px-6">
                <div className="relative w-32 z-10">
                  <select
                    aria-label="Selected tab"
                    className="bg-blue-50 focus:outline-none border border-transparent focus:border-gray-800 focus:shadow-outline-gray text-base form-select block w-full py-2 px-2 xl:px-3 rounded text-gray-600 dark:text-gray-400 appearance-none bg-transparent"
                  >
            ...
            <table className="min-w-full bg-white dark:bg-gray-800">
              <thead>
                <tr className="w-full h-16 border-gray-300 dark:border-gray-200 border-b py-8">
                  ...
                  <th className="dark:text-gray-400 font-bold pr-6 text-left text-sm tracking-normal leading-4 ">
                    ID
                  </th>
                  <th className="dark:text-gray-400 font-bold pr-6 text-left text-sm tracking-normal leading-4">
                    Profile Image
