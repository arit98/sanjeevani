    ...
    return (
      <>
        <motion.div
          ...
          className="fixed top-[78px] left-0 w-[250px] md:w-[250px] lg:h-screen bg-gray-50 drop-shadow-md flex flex-col z-[101] scroll"
        >
          <ProSidebarProvider>
            <aside className="w-[225px] h-screen py-24" aria-label="Sidebar">
