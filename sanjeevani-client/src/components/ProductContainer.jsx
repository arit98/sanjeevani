...
const ProductContainer = () => {
  const [
    { cartShow, loginShow, registerShow, footerShow, cartItems },
    dispatch,
  ] = useStateValue();
  ...
  const [bxcount, setbxCount] = useState(0);
                ...
                <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                  {item.image_details.length > 0 &&
                    item.image_details.map((img) => (
                      <div className="bg-[#f0fdfa] flex justify-center items-center py-4 cursor-pointer" onClick={()=>imageChange(img.image_link)}>
                        <img
                          src={img.image_link}
              ...
              <div className="w-full sm:w-96 md:w-8/12 lg:w-full grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-28 sm:gap-x-6 sm:gap-y-12 gap-y-12 sm:mt-14 mt-10">
                ...
                <div>
                  ...
                  <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                    ...
                    economy. ... Moreover, enhancing the durability of
                ...
                <div>
                  ...
                  <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                    {" "}
                    They re-use, recycle and reduce waste disposal in their
                    lives. They conserve energy and natural resources
                  </p>
                </div>
                <div>
                  <svg
                  ...
                  <p className="text-normal text-base leading-6 text-gray-600 mt-4">
                    Minimalist interior design is very similar to modern
                    interior design and involves using the bare essentials{" "}
                  </p>
                </div>
              </div>
            </div>
