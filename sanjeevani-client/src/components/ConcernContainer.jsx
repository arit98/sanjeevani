...
import cdata from "../utils/about_data";
    ...
    <div>
      <section>
        <div className="container px-6 py-10 mx-auto">
          <h1 className="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl dark:text-textColor">
            Our <span className="text-[#18978F]">Executive Team</span>
          </h1>

          <p className="max-w-2xl mx-auto my-6 text-center text-lighttextGray dark:c">
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
            {cdata &&
              cdata.map((cat) => (
                <div className="px-12 py-8 transition-colors duration-200 transform cursor-pointer hover:border-transparent group hover:bg-[#18978F] shadow-2xl dark:hover:border-transparent rounded-2xl">
                  <div className="flex flex-col sm:-mx-4 sm:flex-row">
                    ...
                    <div className="mt-4 sm:mx-4 sm:mt-0">
                      <h1 className="text-xl font-semibold text-textColor capitalize md:text-2xl group-hover:text-white">
                        {cat.name}
                      </h1>

                      <p className="mt-2 text-[#18978F] capitalize group-hover:text-gray-300">
                        {cat.status}
                      </p>
                    </div>
                  </div>

                  <p className="mt-4 text-textColor capitalize group-hover:text-gray-300">
